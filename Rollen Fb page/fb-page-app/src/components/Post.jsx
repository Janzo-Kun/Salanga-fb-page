    ...
    <div className="post-container">
      ...
      <div className="post-card">
        <div className="post-header">
            ...
            <div className="post-author"><strong>Rollen, Ella Mae</strong></div>
            <div className="post-time">September 19 at 12:00 PM<MdPublic style={{ fontSize: "12px"}}/></div>
          </div>
        </div>
        

        <div className="post-content">
          <p style={{ fontSize: "20px"}}>“Hi” <br /></p>
        </div>
