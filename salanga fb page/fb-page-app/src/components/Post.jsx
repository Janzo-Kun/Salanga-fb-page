    ...
    <div className="post-container">
      ...
      <div className="post-card">
        <div className="post-header">
            ...
            <div className="post-author"><strong>Salanga, Jan Jeremy Y.</strong></div>
            <div className="post-time">September 17 at 5:00 PM<MdPublic style={{ fontSize: "12px"}}/></div>
          </div>
        </div>
        

        <div className="post-content">
          <p style={{ fontSize: "20px"}}>“Legends Never Die!” <br />– Salanga</p>
        </div>
